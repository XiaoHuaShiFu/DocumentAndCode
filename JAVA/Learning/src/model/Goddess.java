...
public class Goddess {
	...
	public Goddess(String user_name, Integer sex, Integer age, Date birthday, String email, String mobile,
			String create_user, String update_user, Integer isdel) {
		super();
	...
	public Goddess(Integer id, String user_name, Integer sex, Integer age, Date birthday, String email, String mobile,
			 String update_user, Integer isdel) {
		super();
		this.id = id;
		this.user_name = user_name;
		this.sex = sex;
